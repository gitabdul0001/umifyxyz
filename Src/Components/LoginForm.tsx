  ...
  return (
    <div className="flex items-center justify-center flex-col text-center">
      <div className="flex justify-center items-center flex-col bg-white h-auto w-auto border-2 border-[#264143] rounded-[20px] shadow-[3px_4px_0px_1px_#E99F4C] px-6 py-4">
        <p className="text-[#264143] font-black text-xl mt-1 mb-3">LOGIN</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center">
          ...
          {error && (
            <div className="text-red-600 text-xs text-center mb-1 max-w-[260px] break-words bg-red-50 p-2 rounded border border-red-200">{error}</div>
          )}
